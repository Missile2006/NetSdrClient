...
namespace NetSdrClientApp.Messages
{
    ...
    public static class NetSdrMessageHelper
    {
        ...
        public enum ControlItemCodes
        {
            ...
            ManualGain = 0x0040,        // Або RFGain, залежно від протоколу
            DeviceStatus = 0x0004,      // Код для статусу пристрою
            Calibration = 0x0080,       // Код для калібрування
            Reset = 0x0008              // Код для скидання
        }
